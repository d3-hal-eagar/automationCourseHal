...
describe("Guest", function() {
    it("should be able to buy item", function() {
        ...
        browser.pause(1000); // waiting for animations to complete
        browser.url("http://ip-5236.sunline.net.ua:38015/checkout");
        ...
        $('input[name="phone"]').setValue(faker.phone.phoneNumber('044#######'));
        $('button[name="save_customer_details"]').waitForDisplayed();
        $('button[name="save_customer_details"]').click();
        browser.waitUntil(
            () =>
                $('button[name="confirm_order"]').getAttribute("disabled") ==
                null,
            undefined,
